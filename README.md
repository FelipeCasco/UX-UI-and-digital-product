...
All projects are presented in Notion for easy navigation, clear structuring, and complete documentation.
...
Below are the main UX/UI and digital product projects developed so far:
Abaixo estão os principais projetos de UX/UI e produtos digitais desenvolvidos até agora:

### **1. Porto Sombrio Escape Game – From UX to UI**

A full product experience structured from user research, personas, journey mapping, wireframes to final UI screens.

Uma experiência completa de produto estruturada desde pesquisa com usuários, personas, jornada, wireframes até telas finais de UI.

🔗 *Access on Notion / Acessar no Notion*: **[https://juvenile-fernleaf-849.notion.site/felipecasco-2a9f4241f42d816e9eacdb536c0dbfbf?p=2a9f4241f42d811bbe64d9e1d5639613&pm=c]**

---

### **2. Itaú – Beyond Banking Strategy**

A strategic service design project focusing on expanding Itaú’s ecosystem beyond traditional banking, including research, opportunity mapping, and solution prototyping.

Projeto estratégico de service design com foco em expandir o ecossistema do Itaú além dos serviços bancários tradicionais, incluindo pesquisa, mapeamento de oportunidades e prototipação de soluções.

🔗 *Access on Notion / Acessar no Notion*: **[https://juvenile-fernleaf-849.notion.site/felipecasco-2a9f4241f42d816e9eacdb536c0dbfbf?p=2a9f4241f42d81ac858eca8921ce731f&pm=c]**

---

### **3. Product Owner Experience – LP Redesign “Mundo Colorado” (Sport Club Internacional)**

Work as a PO alongside a designer to redesign and restructure the landing page for a major football institution, focusing on conversion, clarity and improved UX.
